...
Our attempts to learn from the entire dataset were ultimately unsuccessful due to the diverse nature of the demonstrations - addressing the diversity of the dataset for policy learning is left for future work.
