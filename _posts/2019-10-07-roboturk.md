...
<video autoplay loop muted playsinline class="postimagehalf">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/robot_intelligence_1.mp4" type="video/mp4">
</video>
<video autoplay loop muted playsinline class="postimagehalf">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/robot_intelligence_2.mp4" type="video/mp4">
</video>
...
{% figure %}
<video autoplay loop muted playsinline class="postimagehalf">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/robot_intelligence_3.mp4" type="video/mp4">
</video>
<video autoplay loop muted playsinline class="postimagehalf">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/robot_intelligence_4.mp4" type="video/mp4">
</video>
...
{% figure %}
<video autoplay loop muted playsinline class="postimagehalf">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/need_human_1.mp4" type="video/mp4">
</video>
<video autoplay loop muted playsinline class="postimagehalf">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/need_human_2.mp4" type="video/mp4">
</video>
...
{% figure %}
<img src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/diversity_strategies.png" class="postimagehalf"/>
<figcaption>
</figcaption>
{% endfigure %}
...
{% figure %}
<img src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/dexterity_manipulation.png" class="postimagehalf"/>
<figcaption>
</figcaption>
{% endfigure %}
...
{% figure %}
<img src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/large_scale_situations.png" class="postimagehalf"/>
<figcaption>
</figcaption>
{% endfigure %}
...
<video autoplay loop muted playsinline class="postimageactual">
  <source src="{{ site.baseurl }}/assets/img/posts/2019-10-07-roboturk/macau.mp4" type="video/mp4">
</video>
<figcaption>
